...
async def seed_demo_phase4():
    ...
    await db.audit_logs.insert_many([
        # ─── Logins ────────────────────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "login", "target_id": None, "target_type": "auth", "timestamp": dag(90), "notes": "Login from 10.0.0.1 — session initiated"},
        {"user_id": r_id, "user_email": "risk@zephyrwealth.ai", "user_role": "risk", "user_name": "Marcus Webb", "action": "login", "target_id": None, "target_type": "auth", "timestamp": dag(85), "notes": "Login from 10.0.0.2 — session initiated"},
        {"user_id": m_id, "user_email": "manager@zephyrwealth.ai", "user_role": "manager", "user_name": "Jonathan Morrow", "action": "login", "target_id": None, "target_type": "auth", "timestamp": dag(80), "notes": "Login from 10.0.0.3 — session initiated"},
        # ─── Investor Approvals ────────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "investor_approved", "target_id": inv1_str, "target_type": "investor", "timestamp": dag(46), "notes": "Decision: approve | Cayman Tech Ventures SPV Ltd | Score 88/100 | Low Risk | Result: success"},
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "investor_approved", "target_id": inv3_str, "target_type": "investor", "timestamp": dag(35), "notes": "Decision: approve | Marcus Harrington | Score 82/100 | Low Risk | Result: success"},
        # ─── Investor Rejection ────────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "investor_rejected", "target_id": inv6_str, "target_type": "investor", "timestamp": dag(20), "notes": "Decision: reject | Olympus Private Capital Ltd | Score 18/100 | High Risk | Reason: sanctions flag, unverified UBO, unexplained source of wealth | Result: success"},
        # ─── Investor Flagged ─────────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "investor_flagged", "target_id": inv5_str, "target_type": "investor", "timestamp": dag(28), "notes": "AML concern raised | Meridian Global Holdings Ltd | Bulgarian UBO, Panama registration, unexplained source of wealth — EDD required | Result: success"},
        # ─── Deal Stage Advances ───────────────────────────────────────────────
        {"user_id": r_id, "user_email": "risk@zephyrwealth.ai", "user_role": "risk", "user_name": "Marcus Webb", "action": "deal_stage_moved", "target_id": dd1_str, "target_type": "deal", "timestamp": dag(55), "notes": "CaribPay Solutions Ltd | Leads → Due Diligence | Result: success"},
        {"user_id": r_id, "user_email": "risk@zephyrwealth.ai", "user_role": "risk", "user_name": "Marcus Webb", "action": "deal_stage_moved", "target_id": dd1_str, "target_type": "deal", "timestamp": dag(40), "notes": "CaribPay Solutions Ltd | Due Diligence → IC Review | Result: success"},
        {"user_id": r_id, "user_email": "risk@zephyrwealth.ai", "user_role": "risk", "user_name": "Marcus Webb", "action": "deal_stage_moved", "target_id": dd1_str, "target_type": "deal", "timestamp": dag(7), "notes": "CaribPay Solutions Ltd | IC Review → Closing | Result: success"},
        {"user_id": r_id, "user_email": "risk@zephyrwealth.ai", "user_role": "risk", "user_name": "Marcus Webb", "action": "deal_stage_moved", "target_id": dd2_str, "target_type": "deal", "timestamp": dag(18), "notes": "AgroHub Africa Ltd | Leads → Due Diligence | Result: success"},
        # ─── Transaction Executed ─────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "deal_executed", "target_id": dd1_str, "target_type": "deal", "timestamp": dag(5), "notes": "Transaction executed | CaribPay Solutions Ltd | IBC | $4,200,000 | Result: success"},
        # ─── Mandate Exception Override ───────────────────────────────────────
        {"user_id": r_id, "user_email": "risk@zephyrwealth.ai", "user_role": "risk", "user_name": "Marcus Webb", "action": "mandate_exception_override", "target_id": dd3_str, "target_type": "deal", "timestamp": dag(12), "notes": "Mandate exception approved | InsureSync Caribbean ICON | Insurance sector (not in mandate) | IC approved sector exception — insurance SaaS classified as Financial Services adjacent. Risk Officer override applied. | Result: success"},
        # ─── Capital Calls ────────────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "capital_call_issued", "target_id": None, "target_type": "capital_call", "timestamp": dag(75), "notes": "Capital call issued | Q1 2026 — Initial Drawdown | 20% | Class A+B | Total: $300,000 | 4 investors | Result: success"},
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "capital_call_issued", "target_id": None, "target_type": "capital_call", "timestamp": dag(5), "notes": "Capital call issued | Q2 2026 — Harbour House Acquisition | 25% | Class A+B | Total: $375,000 | 4 investors | Result: success"},
        # ─── Capital Call Receipts ────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "capital_call_received", "target_id": inv1_str, "target_type": "investor", "timestamp": dag(60), "notes": "Payment received | Cayman Tech Ventures SPV Ltd | Q1 2026 Initial Drawdown | $150,000 | Status: received | Result: success"},
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "capital_call_received", "target_id": inv3_str, "target_type": "investor", "timestamp": dag(58), "notes": "Payment received | Marcus Harrington | Q1 2026 Initial Drawdown | $30,000 | Status: received | Result: success"},
        # ─── Distribution Issued ──────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "distribution_issued", "target_id": dd1_str, "target_type": "deal", "timestamp": dag(3), "notes": "Distribution issued | Q1 2026 income distribution | CaribPay Solutions Ltd | $45,000 gross | Class A+B pro-rata | Result: success"},
        # ─── TAV Report Generated ─────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "tav_report_generated", "target_id": None, "target_type": "report", "timestamp": dag(1), "notes": "TAV Report generated | Q1 2026 | Period: 2026-01-01 to 2026-03-31 | Fund: Zephyr Caribbean Growth Fund I | Result: success"},
        # ─── Demo Reset ───────────────────────────────────────────────────────
        {"user_id": c_id, "user_email": "compliance@zephyrwealth.ai", "user_role": "compliance", "user_name": "Sarah Chen", "action": "demo_reset", "target_id": None, "target_type": "system", "timestamp": dag(0), "notes": "Demo data reset executed | Pristine Phase 4 & 5 data restored | Result: success"},
    ])
